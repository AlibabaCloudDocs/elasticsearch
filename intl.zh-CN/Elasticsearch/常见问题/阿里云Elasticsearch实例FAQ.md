...
-   如果您购买的是包年包月的实例，可转换为按量付费，详情请参见[包年包月转按量付费]()。 |
...
|实例规格|支持变更，详情请参见[升配集群](/intl.zh-CN/Elasticsearch/升降配实例/升配集群.md)和[降配集群]()。|
|存储类型|支持变更，详情请参见[升配集群](/intl.zh-CN/Elasticsearch/升降配实例/升配集群.md)和[降配集群]()。|
|云盘加密|不支持变更，建议退订后重新购买。|
|单节点存储空间|支持变更，详情请参见[升配集群](/intl.zh-CN/Elasticsearch/升降配实例/升配集群.md)。|
|数据节点数量|支持变更，详情请参见[升配集群](/intl.zh-CN/Elasticsearch/升降配实例/升配集群.md)和[降配集群]()。|
...
以上未提到的配置，请在集群升配页面或者降配页面进行查验，详情请参见[升配集群](/intl.zh-CN/Elasticsearch/升降配实例/升配集群.md)和[降配集群]()。
...
不支持。阿里云ES不支持自动过期清除策略，因此请手动清除过期的.security索引，详情请参见[（可选）步骤六：删除索引](/intl.zh-CN/Elasticsearch/快速开始.md)。
