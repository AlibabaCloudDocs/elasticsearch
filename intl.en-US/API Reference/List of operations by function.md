...
|[UpdateInstanceChargeType](/intl.en-US/API Reference/Elasticsearch instances/Manage clusters/UpdateInstanceChargeType.md)|Changes the billing method of an Elasticsearch cluster from pay-as-you-go to subscription.|
...
|[UpgradeEngineVersion](/intl.en-US/API Reference/Elasticsearch instances/Upgrade or downgrade a cluster/UpgradeEngineVersion.md)|Upgrades the version or kernel of an Elasticsearch cluster. You can upgrade the version of an Elasticsearch cluster only from V6.3 to V6.7.|
...
|Cluster configuration|[UpdateInstanceSettings](/intl.en-US/API Reference/Elasticsearch instances/Configure clusters/UpdateInstanceSettings.md)|Updates the YML file configuration of a specified Elasticsearch cluster.|
...
|Data backup|[CreateSnapshot](/intl.en-US/API Reference/Elasticsearch instances/Backup data/CreateSnapshot.md)|Manually creates a snapshot in an Elasticsearch cluster.|
...
|[ListSnapshotReposByInstanceId](/intl.en-US/API Reference/Elasticsearch instances/Backup data/ListSnapshotReposByInstanceId.md)|Queries the shared Object Storage Service \(OSS\) repositories configured for an Elasticsearch cluster.|
...
|[ListDefaultCollectorConfigurations](/intl.en-US/API Reference/Beats/ListDefaultCollectorConfigurations.md)|Queries the default configuration file of shippers.|
...
|[ModifyDeployMachine](/intl.en-US/API Reference/Beats/ECS-based deployment/ModifyDeployMachine.md)|Modifies the ECS instance on which a shipper is installed.|
